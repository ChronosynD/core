"""Figure 05, clean-condition false-positive cost of trim_fraction. Bar
chart across naive and Sediment trim variants under unpoisoned windows,
isolating the FP overhead operators pay for poisoning resistance"""
...
def _csv_path() -> Path:
    ...
    return repo_root / "evaluation" / "results" / "exp05_fp_cost.csv"
...
def main() -> None:
    ...
    axes.set_title("Clean-condition FPR by Sediment trim_fraction")
    ...
    save_figure(figure, output_dir / "fig05_fp_cost.pdf")
    plt.close(figure)
    print(f"fig05_fp_cost: wrote PDF to {output_dir}")
