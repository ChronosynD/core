"""Experiment 07, four-way ablation under poisoning. Sweeps the same
budget grid as exp04 across naive, consensus, anomaly-within, and
Sediment so the paper can compare alternative robustness strategies"""
...
def _results_path() -> Path:
    ...
    return results_dir / "exp07_alternatives_ablation.csv"
...
def main() -> None:
    ...
    print(f"exp07_alternatives_ablation: wrote {len(samples)} rows to {path}")
